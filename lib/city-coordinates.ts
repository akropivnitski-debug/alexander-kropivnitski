...
export const cityCoordinates: Record<string, CityCoord> = {
  ...
  'amman': { lat: 31.9454, lng: 35.9284, label: 'Amman' },
  'ankara': { lat: 39.9334, lng: 32.8597, label: 'Ankara' },
  'baghdad': { lat: 33.3152, lng: 44.3661, label: 'Baghdad' },
  'beirut': { lat: 33.8938, lng: 35.5018, label: 'Beirut' },
  ...
  'kuwait-city': { lat: 29.3759, lng: 47.9774, label: 'Kuwait City' },
  'lagos': { lat: 6.5244, lng: 3.3792, label: 'Lagos' },
  'manama': { lat: 26.2285, lng: 50.5860, label: 'Manama' },
  'muscat': { lat: 23.5880, lng: 58.3829, label: 'Muscat' },
  ...
  'edmonton': { lat: 53.5461, lng: -113.4938, label: 'Edmonton' },
  'winnipeg': { lat: 49.8951, lng: -97.1384, label: 'Winnipeg' },
  'quebec-city': { lat: 46.8139, lng: -71.2080, label: 'Quebec City' },
  'halifax': { lat: 44.6488, lng: -63.5752, label: 'Halifax' },
  'victoria-bc': { lat: 48.4284, lng: -123.3656, label: 'Victoria, BC' },

  // ── Australia & New Zealand ──
  'canberra': { lat: -35.2809, lng: 149.1300, label: 'Canberra' },
  ...
  'adelaide': { lat: -34.9285, lng: 138.6007, label: 'Adelaide' },
...
export const cityOptions: { label: string; value: string }[] = [
  ...
  // Middle East & Africa
  { label: '── Middle East & Africa ──', value: '_mea_header' },
  ...
  // Canada
  { label: '── Canada ──', value: '_canada_header' },
  ...
  // Australia & New Zealand
  { label: '── Australia & NZ ──', value: '_aunz_header' },
